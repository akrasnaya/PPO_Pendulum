...
env.set_dt(0.05)
env = ExtendedObsEnv(env, ball_generation=50)

model_upswing = PPO(env)
model_upswing.actor.load_state_dict(torch.load('models/ppo_actor_cartpole_hold12.pth'))
model_upswing.critic.load_state_dict(torch.load('models/ppo_critic_cartpole_hold12.pth'))

model_hold = PPO(env)
model_hold.actor.load_state_dict(torch.load('models/ppo_actor_cartpole_hold13.pth'))
model_hold.critic.load_state_dict(torch.load('models/ppo_critic_cartpole_hold13.pth'))
